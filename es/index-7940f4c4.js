var icons = {
    ...
    loading: '<div class="icon-loading"><svg viewBox="0 -2 59.75 60.25"><path fill="#ccc" d="M29.69-.527C14.044-.527 1.36 12.158 1.36 27.806S14.043 56.14 29.69 56.14c15.65 0 28.334-12.686 28.334-28.334S45.34-.527 29.69-.527zm.185 53.75c-14.037 0-25.417-11.38-25.417-25.417S15.838 2.39 29.875 2.39s25.417 11.38 25.417 25.417-11.38 25.416-25.417 25.416z"/><path fill="none" stroke="#000" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" d="M56.587 29.766c.37-7.438-1.658-14.7-6.393-19.552"/></svg><div>',
    ...
    dislike: '<svg viewBox="0 0 77 77"><g fill="none" fill-rule="evenodd"><path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36zm0-2c18.778 0 34-15.222 34-34S54.778 2 36 2 2 17.222 2 36s15.222 34 34 34z" fill="#000"/><path fill="#000" d="M47 22h2v6h-2zm-24 0h2v6h-2z"/><path d="M21 51s4.6-7 15-7 15 7 15 7" stroke="#000" stroke-width="2"/></g></svg>',
    fail: '<svg viewBox="0 0 77 77"><g fill="none" fill-rule="evenodd"><path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36zm0-2c18.778 0 34-15.222 34-34S54.778 2 36 2 2 17.222 2 36s15.222 34 34 34z" fill="#000"/><path d="M22 22l28.304 28.304m-28.304 0L50.304 22" stroke="#000" stroke-width="2"/></g></svg>',
    success: '<svg viewBox="0 0 77 77"><g fill="none" fill-rule="evenodd"><path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36zm0-2c18.778 0 34-15.222 34-34S54.778 2 36 2 2 17.222 2 36s15.222 34 34 34z" fill="#000"/><path stroke="#000" stroke-width="2" d="M19 34.54l11.545 11.923L52.815 24"/></g></svg>',
};
var svgSprite = function (type) { return icons[type]; };
...
var css_248z = "/* 主题色 */\n/* 文字色 */\n/* 文字大小 */\n/* 圆角 */\n/* 图标大小 */\n/* 水平间距 */\n/* 垂直间距 */\n.zec-icon {\n  display: inline-block;\n  vertical-align: middle;\n}\n.zec-icon .zec-icon-xs {\n  width: 15px;\n  height: 15px;\n}\n.zec-icon .zec-icon-sm {\n  width: 25px;\n  height: 25px;\n}\n.zec-icon .zec-icon-md {\n  width: 30px;\n  height: 30px;\n}\n.zec-icon .zec-icon-lg {\n  width: 44px;\n  height: 44px;\n}\n.zec-icon .icon-loading {\n  height: 100%;\n  animation: turn 2s linear infinite;\n}\n@keyframes turn {\n  0% {\n    -webkit-transform: rotate(0deg);\n  }\n  25% {\n    -webkit-transform: rotate(90deg);\n  }\n  50% {\n    -webkit-transform: rotate(180deg);\n  }\n  75% {\n    -webkit-transform: rotate(270deg);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n  }\n}\n";
styleInject(css_248z);

export { styleInject as a, svgSprite as s };
